...
implements Serializable {
    ...
    public String toString() {
        return "YakJobPO(id=" + this.getId() + ", jobCode=" + this.getJobCode() + ", taskCode=" + this.getTaskCode() + ", className=" + this.getClassName() + ", tryTimes=" + this.getTryTimes() + ", workerCode=" + this.getWorkerCode() + ", startTime=" + this.getStartTime() + ", appName=" + this.getAppName() + ")";
    }
    ...
    protected boolean canEqual(Object other) {
        return other instanceof YakJobPO;
    }
