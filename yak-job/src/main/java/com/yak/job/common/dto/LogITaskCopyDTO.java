...
public class LogITaskCopyDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogITaskCopyDTO)) {
            return false;
        }
        LogITaskCopyDTO other = (LogITaskCopyDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogITaskCopyDTO;
    }
    ...
    public String toString() {
        return "LogITaskCopyDTO(taskDesc=" + this.getTaskDesc() + ", workerIps=" + this.getWorkerIps() + ", param=" + this.getParam() + ")";
    }
}
