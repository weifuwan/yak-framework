...
public class LogIJobDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogIJobDTO)) {
            return false;
        }
        LogIJobDTO other = (LogIJobDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogIJobDTO;
    }
    ...
    public String toString() {
        return "LogIJobDTO(code=" + this.getCode() + ", taskCode=" + this.getTaskCode() + ", className=" + this.getClassName() + ", tryTimes=" + this.getTryTimes() + ", workerCode=" + this.getWorkerCode() + ", startTime=" + this.getStartTime() + ", createTime=" + this.getCreateTime() + ", updateTime=" + this.getUpdateTime() + ")";
    }
}
