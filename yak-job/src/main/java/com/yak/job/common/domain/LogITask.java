...
public class LogITask {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogITask)) {
            return false;
        }
        LogITask other = (LogITask)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogITask;
    }
    ...
    public static class TaskWorker {
        ...
        public String toString() {
            return "LogITask.TaskWorker(status=" + this.getStatus() + ", lastFireTime=" + this.getLastFireTime() + ", workerCode=" + this.getWorkerCode() + ", ip=" + this.getIp() + ")";
        }
