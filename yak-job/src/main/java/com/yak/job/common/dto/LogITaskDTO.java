...
public class LogITaskDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogITaskDTO)) {
            return false;
        }
        LogITaskDTO other = (LogITaskDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogITaskDTO;
    }
    ...
    public String toString() {
        return "LogITaskDTO(name=" + this.getName() + ", description=" + this.getDescription() + ", cron=" + this.getCron() + ", className=" + this.getClassName() + ", params=" + this.getParams() + ", retryTimes=" + this.getRetryTimes() + ", consensual=" + this.getConsensual() + ")";
    }
}
