...
Cloneable {
    ...
    protected void buildExpression(String expression) throws ParseException {
        ...
        try {
            ...
            boolean bl = dayOfW = !dow.contains(NO_SPEC);
            if (!(dayOfM && !dayOfW || dayOfW && !dayOfM)) {
    ...
    public Date getTimeAfter(Date afterTime) {
        ...
        while (!gotOne) {
            ...
            t = -1;
            int tmon = mon;
            boolean dayOfM = !this.daysOfMonth.contains(NO_SPEC);
            boolean bl = dayOfW = !this.daysOfWeek.contains(NO_SPEC);
            if (dayOfM && !dayOfW) {
                int dow;
                int ldom;
