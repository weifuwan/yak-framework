...
public interface YakTaskMapper {
    ...
    int insert(YakTaskPO var1);

    @Delete(value = {"delete from yak_task where task_code=#{taskCode} and app_name=#{appName}"})
    int deleteByCode(@Param(value = "taskCode") String var1, @Param(value = "appName") String var2);
    ...
    YakTaskPO selectByCode(@Param(value = "taskCode") String var1, @Param(value = "appName") String var2);
    ...
    List<YakTaskPO> selectByCodes(@Param(value = "codes") List<String> var1, @Param(value = "appName") String var2);
    ...
    List<YakTaskPO> selectByAppName(@Param(value = "appName") String var1);
    ...
    List<YakTaskPO> selectRuningByAppName(@Param(value = "appName") String var1);
    ...
    List<YakTaskPO> selectByAppNameAndSize(@Param(value = "appName") String var1, @Param(value = "start") int var2, @Param(value = "size") int var3);

    @Select(value = {"select count(1) from yak_task where app_name=#{appName}"})
    int selectCountByAppName(@Param(value = "appName") String var1);

    List<YakTaskPO> pagineListByCondition(@Param(value = "appName") String var1, @Param(value = "id") Long var2, @Param(value = "taskDesc") String var3, @Param(value = "className") String var4, @Param(value = "jobStatus") Integer var5, @Param(value = "start") Integer var6, @Param(value = "size") Integer var7);

    Integer pagineCountByCondition(@Param(value = "appName") String var1, @Param(value = "id") Long var2, @Param(value = "taskDesc") String var3, @Param(value = "className") String var4, @Param(value = "jobStatus") Integer var5);
}
