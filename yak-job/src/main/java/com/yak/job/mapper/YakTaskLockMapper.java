...
public interface YakTaskLockMapper {
    ...
    int insert(YakTaskLockPO var1);

    @Update(value = {"update yak_task_lock set expire_time=#{expireTime} where id=#{id}"})
    int update(@Param(value = "id") Long var1, @Param(value = "expireTime") Long var2);
    ...
    List<YakTaskLockPO> selectByAppName(@Param(value = "appName") String var1);
    ...
    List<YakTaskLockPO> selectByTaskCode(@Param(value = "taskCode") String var1, @Param(value = "appName") String var2);
    ...
    List<YakTaskLockPO> selectByWorkerCode(@Param(value = "workerCode") String var1, @Param(value = "appName") String var2);
    ...
    List<YakTaskLockPO> selectByTaskCodeAndWorkerCode(@Param(value = "taskCode") String var1, @Param(value = "workerCode") String var2, @Param(value = "appName") String var3);

    @Delete(value = {"delete from yak_task_lock where id=#{id}"})
    int deleteById(@Param(value = "id") Long var1);

    @Delete(value = {"delete from yak_task_lock where worker_code=#{workerCode} and app_name=#{appName}"})
    int deleteByWorkerCodeAndAppName(@Param(value = "workerCode") String var1, @Param(value = "appName") String var2);

    int deleteByIds(List<Long> var1);
}
