drop table if exists `yak_task`;
CREATE TABLE `yak_task`
(
...
drop table if exists `yak_task_lock`;
CREATE TABLE `yak_task_lock`
(
    `id`          BIGINT(20) auto_increment,
    `task_code`   VARCHAR(100) DEFAULT '' NOT NULL COMMENT 'task taskCode',
...
drop table if exists `yak_job`;
CREATE TABLE `yak_job`
(
    `id`          BIGINT(20) auto_increment,
...
drop table if exists `yak_job_log`;
CREATE TABLE `yak_job_log`
(
    `id`          BIGINT(20) auto_increment,
...
drop table if exists `yak_worker_blacklist`;
CREATE TABLE `yak_worker_blacklist`
(
    `id`          BIGINT(20) auto_increment,
    `worker_code` VARCHAR(100) DEFAULT '' NOT NULL COMMENT 'worker taskCode',
    `create_time` DATETIME     DEFAULT NOW() COMMENT '创建时间',
