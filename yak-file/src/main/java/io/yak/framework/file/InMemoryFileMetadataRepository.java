...
public class InMemoryFileMetadataRepository implements FileMetadataRepository {
 ...
 public void save(FileMetadata v){values.put(v.getId(),v);} public FileMetadata find(String id){return values.get(id);} public void delete(String id){values.remove(id);}
}
