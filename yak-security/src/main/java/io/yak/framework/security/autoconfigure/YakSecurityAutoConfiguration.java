...
public class YakSecurityAutoConfiguration {
  ...
  PermissionRegistrationService
      yakPermissionRegistrationService(
          PermissionDao permissionDao) {
    return new PermissionRegistrationService(
        permissionDao);
  }
  ...
  @ConditionalOnProperty(
      ...
      havingValue = "true",
      matchIfMissing = true)
  PermissionRegistrationInitializer
      yakPermissionRegistrationInitializer(
          org.springframework.beans.factory
              .ListableBeanFactory beanFactory,
          PermissionRegistrationService
              registrationService) {
    return new PermissionRegistrationInitializer(
        beanFactory,
        registrationService);
  }
  ...
  @ConditionalOnProperty(
      ...
      name = "enabled",
      havingValue = "true")
  YakSecurityBootstrapInitializer
      yakSecurityBootstrapInitializer(
  ...
  static class ExtensionConfiguration {
    ...
    TenantContextProvider
        tenantContextProvider(
            ObjectProvider<TenantRepository>
                tenantRepositoryProvider,
            ObjectProvider<UserTenantRepository>
    ...
    @Bean
    @ConditionalOnMissingBean(
        YakSecurityContextFilter.class)
    @ConditionalOnWebApplication(
        type =
            ConditionalOnWebApplication
                .Type.SERVLET)
    YakSecurityContextFilter
        yakSecurityContextFilter(
