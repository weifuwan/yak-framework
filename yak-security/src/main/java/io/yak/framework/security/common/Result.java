...
public class Result<T> extends BaseResult {
  ...
  public boolean successed() {
    return this.getCode() != null &&
        ResultCode.SUCCESS.getCode().equals(this.getCode());
  }

  public boolean duplicate() {
    return this.getCode() != null &&
        ResultCode.RESOURCE_DUPLICATION.getCode().equals(this.getCode());
  }

  public boolean failed() { return !this.successed(); }

  public Result() {}

  private Result(Integer code) { this.code = code; }
  ...
  public static <T> Result<T> fail(YakSecurityException e) {
  ...
  public static <T> Result<T> buildParamIllegal(String msg) {
    ...
    result.setMessage(
        ResultCode.PARAM_NOT_VALID.getMessage() + ":" + msg +
        "\uff0c\u8bf7\u68c0\u67e5\u540e\u518d\u63d0\u4ea4\uff01");
    return result;
  }
