...
public class OplogDaoImpl extends BaseDaoImpl<OplogPO> implements OplogDao {
  ...
  public IPage<Oplog> selectPageWithoutDetail(OplogQueryDTO queryDTO) {
    ...
    ((QueryWrapper)((QueryWrapper)((QueryWrapper)((QueryWrapper)((QueryWrapper)queryWrapper
                                                                     .eq(queryDTO.getOperateType() !=
                                                                             null,
                                                                         (Object) "operate_type",
                                                                         (Object)queryDTO
                                                                             .getOperateType()))
                                                      .eq(queryDTO.getTargetType() !=
                                                              null,
                                                          (Object) ("target_" +
                                                                    "type"),
                                                          (Object)queryDTO
                                       ...
                                       .eq(StringUtils.hasText(
                                               (String)queryDTO
                                                   .getOperationMethods()),
                                           (Object) "operation_methods",
                                           (Object)
                                               queryDTO.getOperationMethods()))
                        .like(
                            !StringUtils.isEmpty((Object)queryDTO.getDetail()),
                            (Object) "detail", (Object)queryDTO.getDetail()))
         .like(!StringUtils.isEmpty((Object)queryDTO.getTarget()),
               (Object) "target", (Object)queryDTO.getTarget()))
        .like(!StringUtils.isEmpty((Object)queryDTO.getOperator()),
              (Object) "operator", (Object)queryDTO.getOperator());
    if (queryDTO.getStartTime() != null) {
      queryWrapper.ge((Object) "create_time",
                      (Object) new Timestamp(queryDTO.getStartTime()));
    }
    if (queryDTO.getEndTime() != null) {
      queryWrapper.le((Object) "create_time",
                      (Object) new Timestamp(queryDTO.getEndTime()));
    }
  ...
  public Oplog selectByOplogId(Long oplogId) {
    ...
    return CopyBeanUtil.copy(this.oplogMapper.selectOne((Wrapper)queryWrapper),
                             Oplog.class);
  }
