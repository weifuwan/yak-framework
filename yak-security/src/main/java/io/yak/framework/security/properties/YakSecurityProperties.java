...
@Validated
@ConfigurationProperties(value = "spring.yak-security")
public class YakSecurityProperties {
  @NotEmpty(message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981" +
                      "\u914d\u7f6e[yak.security.app-name]\u5c5e\u6027")
  private @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.app-name]\u5c5e\u6027") String appName;
  @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.resource-extend-bean-name]\u5c5e\u6027")
  private @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.resource-extend-bean-name]\u5c5e\u6027")
  String resourceExtendBeanName;
  private String loginExtendBeanName;
  @NotEmpty(message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981" +
                      "\u914d\u7f6e[yak.security.username]\u5c5e\u6027")
  private @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.username]\u5c5e\u6027") String username;
  @NotEmpty(message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981" +
                      "\u914d\u7f6e[yak.security.password]\u5c5e\u6027")
  private @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.password]\u5c5e\u6027") String password;
  @NotEmpty(message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981" +
                      "\u914d\u7f6e[yak.security.url]\u5c5e\u6027")
  private @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.url]\u5c5e\u6027") String jdbcUrl;
  @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.driver-class-name]\u5c5e\u6027")
  private @NotEmpty(
      message = "\u914d\u7f6e\u6587\u4ef6\u914d\u7f6e\u5fc5\u987b\u8981\u914d" +
                "\u7f6e[yak.security.driver-class-name]\u5c5e\u6027") String
      driverClassName;
  ...
  public String getLoginExtendBeanName() { return this.loginExtendBeanName; }
  ...
  public boolean equals(Object o) {
    ...
    if (!(o instanceof YakSecurityProperties)) {
      return false;
    }
    YakSecurityProperties other = (YakSecurityProperties)o;
    ...
    if (this$resourceExtendBeanName == null
            ? other$resourceExtendBeanName != null
            : !this$resourceExtendBeanName.equals(
                  other$resourceExtendBeanName)) {
      return false;
    }
    String this$loginExtendBeanName = this.getLoginExtendBeanName();
    String other$loginExtendBeanName = other.getLoginExtendBeanName();
    if (this$loginExtendBeanName == null
            ? other$loginExtendBeanName != null
            : !this$loginExtendBeanName.equals(other$loginExtendBeanName)) {
      return false;
    }
    ...
    if (this$jdbcUrl == null ? other$jdbcUrl != null
    ...
    return !(this$driverClassName == null
                 ? other$driverClassName != null
                 : !this$driverClassName.equals(other$driverClassName));
  }

  protected boolean canEqual(Object other) {
    return other instanceof YakSecurityProperties;
  }
  ...
  public int hashCode() {
    ...
    result = result * 59 + ($resourceExtendBeanName == null
                                ? 43
                                : $resourceExtendBeanName.hashCode());
    String $loginExtendBeanName = this.getLoginExtendBeanName();
    result =
        result * 59 +
        ($loginExtendBeanName == null ? 43 : $loginExtendBeanName.hashCode());
  ...
  public String toString() {
    return "YakSecurityProperties(appName=" + this.getAppName() +
        ", resourceExtendBeanName=" + this.getResourceExtendBeanName() +
        ", loginExtendBeanName=" + this.getLoginExtendBeanName() +
