 ...
 */
package com.yak.security.common.vo.permission;
...
public class PermissionTreeVO {
    ...
    PermissionTreeVO(Integer id, Boolean has, String permissionName, Integer parentId, Boolean leaf, List<PermissionTreeVO> childList) {
        this.id = id;
        this.has = has;
    ...
    public String toString() {
        return "PermissionTreeVO(id=" + this.getId() + ", has=" + this.getHas() + ", permissionName=" + this.getPermissionName() + ", parentId=" + this.getParentId() + ", leaf=" + this.getLeaf() + ", childList=" + this.getChildList() + ")";
    }
    ...
    public static class PermissionTreeVOBuilder {
        ...
        public PermissionTreeVO build() {
            return new PermissionTreeVO(this.id, this.has, this.permissionName, this.parentId, this.leaf, this.childList);
        }

        public String toString() {
            return "PermissionTreeVO.PermissionTreeVOBuilder(id=" + this.id + ", has=" + this.has + ", permissionName=" + this.permissionName + ", parentId=" + this.parentId + ", leaf=" + this.leaf + ", childList=" + this.childList + ")";
        }
    }
}
