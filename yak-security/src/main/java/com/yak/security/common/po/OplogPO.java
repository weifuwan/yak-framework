...
extends BasePO {
    ...
    public String toString() {
        return "OplogPO(operatorIp=" + this.getOperatorIp() + ", operator=" + this.getOperator() + ", operateType=" + this.getOperateType() + ", target=" + this.getTarget() + ", targetType=" + this.getTargetType() + ", detail=" + this.getDetail() + ")";
    }
}
