 ...
 */
package com.yak.security.common.dto.message;
...
public class MessageDTO {
    ...
    public String toString() {
        return "MessageDTO(title=" + this.getTitle() + ", content=" + this.getContent() + ", oplogId=" + this.getOplogId() + ", userId=" + this.getUserId() + ")";
    }
}
