...
extends PageParamDTO {
    ...
    public String toString() {
        return "UserBriefQueryDTO(userName=" + this.getUserName() + ", realName=" + this.getRealName() + ", deptId=" + this.getDeptId() + ", deptName=" + this.getDeptName() + ")";
    }
}
