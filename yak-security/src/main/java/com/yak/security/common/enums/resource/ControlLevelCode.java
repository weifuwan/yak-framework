 ...
 */
package com.yak.security.common.enums.resource;
...
public enum ControlLevelCode {
    ...
    public static ControlLevelCode getByType(Integer type) {
        ...
        for (ControlLevelCode controlLevelCode : controlLevelCodes = ControlLevelCode.values()) {
            if (!controlLevelCode.type.equals(type)) continue;
