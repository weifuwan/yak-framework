 ...
 */
package com.yak.security.common.vo.user;
...
public class UserVO {
    ...
    public String toString() {
        return "UserVO(id=" + this.getId() + ", userName=" + this.getUserName() + ", realName=" + this.getRealName() + ", phone=" + this.getPhone() + ", email=" + this.getEmail() + ", updateTime=" + this.getUpdateTime() + ", createTime=" + this.getCreateTime() + ", roleList=" + this.getRoleList() + ", permissionTreeVO=" + this.getPermissionTreeVO() + ", projectList=" + this.getProjectList() + ")";
    }
}
