...
extends BasePO {
    ...
    public String toString() {
        return "ProjectPO(projectName=" + this.getProjectName() + ", projectCode=" + this.getProjectCode() + ", description=" + this.getDescription() + ", running=" + this.getRunning() + ", deptId=" + this.getDeptId() + ")";
    }
}
