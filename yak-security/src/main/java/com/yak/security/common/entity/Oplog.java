 ...
 */
package com.yak.security.common.entity;
...
extends BaseEntity {
    ...
    public String toString() {
        return "Oplog(operatorIp=" + this.getOperatorIp() + ", operator=" + this.getOperator() + ", operateType=" + this.getOperateType() + ", targetType=" + this.getTargetType() + ", target=" + this.getTarget() + ", detail=" + this.getDetail() + ", operationMethods=" + this.getOperationMethods() + ")";
    }
}
