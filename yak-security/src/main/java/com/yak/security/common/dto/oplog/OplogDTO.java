...
public class OplogDTO {
    ...
    public OplogDTO(String operator, String operateType, String targetType, String target, String detail, String operationMethods) {
    ...
    public String toString() {
        return "OplogDTO(operator=" + this.getOperator() + ", operateType=" + this.getOperateType() + ", targetType=" + this.getTargetType() + ", target=" + this.getTarget() + ", detail=" + this.getDetail() + ", operationMethods=" + this.getOperationMethods() + ")";
    }
}
