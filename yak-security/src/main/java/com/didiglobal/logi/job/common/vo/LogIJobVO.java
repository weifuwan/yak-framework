...
public class LogIJobVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogIJobVO)) {
            return false;
        }
        LogIJobVO other = (LogIJobVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogIJobVO;
    }
    ...
    public String toString() {
        return "LogIJobVO(jobCode=" + this.getJobCode() + ", taskCode=" + this.getTaskCode() + ", className=" + this.getClassName() + ", workerCode=" + this.getWorkerCode() + ", error=" + this.getError() + ", createTime=" + this.getCreateTime() + ", result=" + this.getResult() + ")";
    }
}
