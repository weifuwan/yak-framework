...
public class LogIJobLogDTO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogIJobLogDTO)) {
            return false;
        }
        LogIJobLogDTO other = (LogIJobLogDTO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogIJobLogDTO;
    }
