...
public class LogITaskVO {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogITaskVO)) {
            return false;
        }
        LogITaskVO other = (LogITaskVO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogITaskVO;
    }
