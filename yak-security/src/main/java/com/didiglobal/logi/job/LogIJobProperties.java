...
@ConfigurationProperties(value="spring.logi-job")
public class LogIJobProperties {
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogIJobProperties)) {
            return false;
        }
        LogIJobProperties other = (LogIJobProperties)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogIJobProperties;
    }
