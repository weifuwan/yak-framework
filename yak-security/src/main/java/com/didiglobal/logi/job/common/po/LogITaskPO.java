...
implements Serializable {
    ...
    public LogITaskPO setId(Long id) {
        this.id = id;
        return this;
    }

    public LogITaskPO setTaskCode(String taskCode) {
        this.taskCode = taskCode;
        return this;
    }

    public LogITaskPO setTaskName(String taskName) {
        this.taskName = taskName;
        return this;
    }

    public LogITaskPO setTaskDesc(String taskDesc) {
        this.taskDesc = taskDesc;
        return this;
    }

    public LogITaskPO setCron(String cron) {
        this.cron = cron;
        return this;
    }

    public LogITaskPO setClassName(String className) {
        this.className = className;
        return this;
    }

    public LogITaskPO setParams(String params) {
        this.params = params;
        return this;
    }

    public LogITaskPO setRetryTimes(Integer retryTimes) {
        this.retryTimes = retryTimes;
        return this;
    }

    public LogITaskPO setLastFireTime(Timestamp lastFireTime) {
        this.lastFireTime = lastFireTime;
        return this;
    }

    public LogITaskPO setTimeout(Long timeout) {
        this.timeout = timeout;
        return this;
    }

    public LogITaskPO setStatus(Integer status) {
        this.status = status;
        return this;
    }

    public LogITaskPO setSubTaskCodes(String subTaskCodes) {
        this.subTaskCodes = subTaskCodes;
        return this;
    }

    public LogITaskPO setConsensual(String consensual) {
        this.consensual = consensual;
        return this;
    }

    public LogITaskPO setTaskWorkerStr(String taskWorkerStr) {
        this.taskWorkerStr = taskWorkerStr;
        return this;
    }

    public LogITaskPO setAppName(String appName) {
        this.appName = appName;
        return this;
    }

    public LogITaskPO setOwner(String owner) {
        this.owner = owner;
        return this;
    }
    ...
    public boolean equals(Object o) {
        ...
        if (!(o instanceof LogITaskPO)) {
            return false;
        }
        LogITaskPO other = (LogITaskPO)o;
    ...
    protected boolean canEqual(Object other) {
        return other instanceof LogITaskPO;
    }
