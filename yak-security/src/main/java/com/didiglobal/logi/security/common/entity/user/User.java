...
extends BaseEntity {
    ...
    public String toString() {
        return "User(userName=" + this.getUserName() + ", pw=" + this.getPw() + ", salt=" + this.getSalt() + ", realName=" + this.getRealName() + ", phone=" + this.getPhone() + ", email=" + this.getEmail() + ", deptId=" + this.getDeptId() + ")";
    }
}
